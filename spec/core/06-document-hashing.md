...
**Content transforms.** Apply to `content/document.json`, across all block types including `namespace:type` extension blocks — uniformly, but for the position scoping item 4 names and the two id-relabeling exceptions item 5 names:
